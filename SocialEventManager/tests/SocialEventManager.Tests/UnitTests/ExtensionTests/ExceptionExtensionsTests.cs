...
public sealed class ExceptionExtensionsTests
{
    ...
    public void ToHttpStatusCodeAndTitle_Should_ReturnCorrectResult_When_Called(Exception? ex, (HttpStatusCode, string) expectedResult)
    {
    ...
    public void IsCritical_Should_ReturnCorrectResult_When_Called(Exception? ex, bool expectedResult)
    {
